...
#[doc = "Possible values of the field `RPS`"]
...
impl RPSR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            RPSR::STOPPED => 0,
            RPSR::RUNNINGFETCHING => 1,
            RPSR::RUNNINGWAITING => 3,
            RPSR::SUSPENDED => 4,
            RPSR::RUNNINGWRITING => 7,
            RPSR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> RPSR {
        match value {
            0 => RPSR::STOPPED,
            1 => RPSR::RUNNINGFETCHING,
            3 => RPSR::RUNNINGWAITING,
            4 => RPSR::SUSPENDED,
            7 => RPSR::RUNNINGWRITING,
            i => RPSR::_Reserved(i),
        }
    }
...
impl TPSR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            TPSR::STOPPED => 0,
            TPSR::RUNNINGFETCHING => 1,
            TPSR::RUNNINGWAITING => 2,
            TPSR::RUNNINGREADING => 3,
            TPSR::SUSPENDED => 6,
            TPSR::RUNNING => 7,
            TPSR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> TPSR {
        match value {
            0 => TPSR::STOPPED,
            1 => TPSR::RUNNINGFETCHING,
            2 => TPSR::RUNNINGWAITING,
            3 => TPSR::RUNNINGREADING,
            6 => TPSR::SUSPENDED,
            7 => TPSR::RUNNING,
            i => TPSR::_Reserved(i),
        }
