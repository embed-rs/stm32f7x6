#![doc = "Peripheral access API for STM32F7X6 microcontrollers (generated using svd2rust v0.13.1)\n\nYou can find an overview of the API [here].\n\n[here]: https://docs.rs/svd2rust/0.13.1/svd2rust/#peripheral-api"]
#![deny(missing_docs)]
#![deny(warnings)]
...
pub enum Interrupt {
    ...
    LCD_TFT,
    #[doc = "89 - LTDC Error global interrupt"]
    LTDC_ER,
